...
export default function Page() { return <AppLegalPage app={persianSwipeApp} eyebrow="Persian Swipe" title="Persian Swipe" lede="Persian, in one motion: an offline Persian keyboard with swipe prediction and local correction learning." updated="September 12, 2026" sections={[{"id": "typing", "label": "Swipe or tap"}, {"id": "learning", "label": "Learns from corrections"}, {"id": "privacy", "label": "Local by design"}, {"id": "availability", "label": "Availability"}]}>
...
<LegalSection id="availability" title="Availability"><p>{"Persian Swipe is being prepared for the App Store as a one-time paid download. There are no subscriptions or in-app purchases. Apple displays the current price and availability in each storefront."}</p></LegalSection>
